            ...
            <div class="product-info">
                ...
                <div class="actions">
                    <div class="quantity-slider-group">
                        ...
                        <input type="range" id="quantity-slider" min="1" max="10" value="1" class="quantity-slider">
                    </div>
                    <div class="button-group">
                       <button class="add-to-cart-btn-main" data-product-id="${product.id}">Add to Cart</button>
        ...
        container.innerHTML = cart.map(item => `
            <div class="flex items-center p-4 bg-white rounded-xl shadow-sm">
                ...
                <div class="text-right">
                     ...
                     <button class="remove-from-cart-btn text-red-500 text-sm mt-1" data-product-id="${item.id}">Remove</button>
                </div>
            </div>`).join('');
...
document.body.addEventListener('input', (e) => {
    // New listener specifically for the slider
